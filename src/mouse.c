...
void move_and_right_click(Mouse *mouse, float dx, float dy)
{
	...
	CGEventRef right_click_down =
		CGEventCreateMouseEvent(NULL, kCGEventRightMouseDown,
					CGPointMake(mouse->x, mouse->y),
					kCGMouseButtonRight);
	CGEventRef right_click_up =
		CGEventCreateMouseEvent(NULL, kCGEventRightMouseUp,
					CGPointMake(mouse->x, mouse->y),
					kCGMouseButtonRight);
